...
class DopeNetwork(nn.Module):
    ...
    def forward(self, x):
        ...
        print("out1_2 's size:" + str(out1_2.size()))
        print("out1_1 's size:" + str(out1_1.size()))
        ...
        print("out2_2 's size:" + str(out2_2.size()))
        print("out2_1 's size:" + str(out2_1.size()))
        ...
        print("out3_2 's size:" + str(out3_2.size()))
        print("out3_1 's size:" + str(out3_1.size()))
