...
class DopeNetwork(nn.Module):
    def __init__(
            ...
            numBeliefMap=9,
            numAffinity=16,
            stop_at_stage=2  # number of stages to process (if less than total number of stages)
        ):
    ...
    def forward(self, x):
        ...
        out1_2 = self.m1_2(out25) #out1
        out1_1 = self.m1_1(out25)   #out1
        ...
        out2 = torch.cat([out1_2, out1_1, out25], 1) #out1
        ...
        out3 = torch.cat([out2_2, out2_1, out25], 1) #out1
        ...
        out4 = torch.cat([out3_2, out3_1, out25], 1) #out1
        ...
        out5 = torch.cat([out4_2, out4_1, out25], 1) #out1
        ...
        out6 = torch.cat([out5_2, out5_1, out25], 1) #out1
            ...
            for i_lists in range(len(all_peaks[:-1])):
                ...
                for candidate in lists:
                    ...
                    if objects[i_best][1][i_lists] is None \
                        ...
                        objects[i_best][1][i_lists] = ((candidate[0])*4, (candidate[1])*4)
