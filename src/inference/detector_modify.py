...
def draw_features_heatmap(width,height,x,savename):
    tic=time.time()
    fig = plt.figure(figsize=(16, 16))
    fig.subplots_adjust(left=0.05, right=0.95, bottom=0.05, top=0.95, wspace=0.05, hspace=0.05)
    for i in range(width*height):
...
class DopeNetwork(nn.Module):
    ...
    def forward(self, x):
        ...
        # out23 = self.vgg23(out20) #add own layers
        # out24 = self.vgg24(out23)
        
        out25 = self.vgg25(out17)
        ...
        # print("out0\n")
        # draw_features_heatmap(8,8,out0.cpu().detach(),"{}/out0.png".format(savepath));print("out1\n")
        # draw_features_heatmap(8,8,out1.cpu().detach(),"{}/out1.png".format(savepath));print("out2\n")
        # draw_features_heatmap(8,8,out2.cpu().detach(),"{}/out2.png".format(savepath));print("out3\n")
        # draw_features_heatmap(8,8,out3.cpu().detach(),"{}/out3.png".format(savepath));print("out4\n")
        # draw_features_heatmap(8,8,out4.cpu().detach(),"{}/out4.png".format(savepath));print("out5\n")
        # draw_features_heatmap(8,8,out5.cpu().detach(),"{}/out5.png".format(savepath));print("out6\n")
        # draw_features_heatmap(8,8,out6.cpu().detach(),"{}/out6.png".format(savepath));print("out7\n")
        # draw_features_heatmap(8,8,out7.cpu().detach(),"{}/out7.png".format(savepath));print("out8\n")
        # draw_features_heatmap(8,8,out8.cpu().detach(),"{}/out8.png".format(savepath));print("out9\n")
        # draw_features_heatmap(8,8,out9.cpu().detach(),"{}/out9.png".format(savepath));print("out10\n")
        # draw_features_heatmap(8,8,out10.cpu().detach(),"{}/out10.png".format(savepath));print("out11\n")
        # draw_features_heatmap(8,8,out11.cpu().detach(),"{}/out11.png".format(savepath));print("out12\n")
        # draw_features_heatmap(8,8,out12.cpu().detach(),"{}/out12.png".format(savepath));print("out13\n")
        # draw_features_heatmap(8,8,out13.cpu().detach(),"{}/out13.png".format(savepath));print("out14\n")
        # draw_features_heatmap(8,8,out14.cpu().detach(),"{}/out14.png".format(savepath));print("out15\n")
        # draw_features_heatmap(8,8,out15.cpu().detach(),"{}/out15.png".format(savepath));print("out16\n")
        # draw_features_heatmap(8,8,out16.cpu().detach(),"{}/out16.png".format(savepath));print("out17\n")
        # draw_features_heatmap(8,8,out17.cpu().detach(),"{}/out17.png".format(savepath));print("out18\n")
        # draw_features_heatmap(8,8,out18.cpu().detach(),"{}/out18.png".format(savepath));print("out19\n")
        # draw_features_heatmap(8,8,out19.cpu().detach(),"{}/out19.png".format(savepath));print("out20\n")
        # draw_features_heatmap(8,8,out20.cpu().detach(),"{}/out20.png".format(savepath));print("out21\n")
        # draw_features_heatmap(8,8,out21.cpu().detach(),"{}/out21.png".format(savepath));print("out22\n")
        # draw_features_heatmap(8,8,out22.cpu().detach(),"{}/out22.png".format(savepath));print("out23\n")
        # draw_features_heatmap(8,8,out23.cpu().detach(),"{}/out23.png".format(savepath));print("out24\n")
        # draw_features_heatmap(8,8,out24.cpu().detach(),"{}/out24.png".format(savepath));print("out25\n")
        # draw_features_heatmap(8,8,out25.cpu().detach(),"{}/out25.png".format(savepath));print("out26\n")
        # draw_features_heatmap(8,8,out26.cpu().detach(),"{}/out26.png".format(savepath));print("END\n")
