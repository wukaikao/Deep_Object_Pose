...
class DopeNetwork(nn.Module):
    def __init__(
        ...
        self.vgg27 = nn.Sequential()
        self.vgg28 = nn.Sequential()
        self.vgg29 = nn.Sequential()
        self.vgg30 = nn.Sequential()
        self.vgg31 = nn.Sequential()
        self.vgg32 = nn.Sequential()
        self.vgg33 = nn.Sequential()
        self.vgg34 = nn.Sequential()
        self.vgg35 = nn.Sequential()
        ...
        self.vgg23.add_module(str(23), vgg_full[23])
        self.vgg24.add_module(str(24), vgg_full[24])
        self.vgg25.add_module(str(25), vgg_full[25])
        self.vgg26.add_module(str(26), vgg_full[26])
        self.vgg27.add_module(str(27), vgg_full[27])
        self.vgg28.add_module(str(28), vgg_full[28])
        self.vgg29.add_module(str(29), vgg_full[29])
        self.vgg30.add_module(str(30), vgg_full[30])
        self.vgg31.add_module(str(31), vgg_full[31])
        # Add some layers
        # i_layer = 23
        ...
        self.vgg32.add_module(str(i_layer), nn.Conv2d(512, 256, kernel_size=3, stride=1, padding=1))
        self.vgg33.add_module(str(i_layer+1), nn.ReLU(inplace=True))
        self.vgg34.add_module(str(i_layer+2), nn.Conv2d(256, 128, kernel_size=3, stride=1, padding=1))
        self.vgg35.add_module(str(i_layer+3), nn.ReLU(inplace=True))
    ...
    def forward(self, x):
        ...
        out27 = self.vgg27(out26) #add own layers
        out28 = self.vgg28(out27)
        out29 = self.vgg29(out28)
        out30 = self.vgg30(out29)
        out31 = self.vgg31(out30) #add own layers
        out32 = self.vgg32(out31)
        out33 = self.vgg33(out32)
        out34 = self.vgg34(out33)
        out35 = self.vgg35(out34) #add own layers
        ...
        # draw_features_heatmap(5,5,out26.cpu().detach(),x.cpu().detach(),"{}/out26.png".format(savepath));print("out27\n")
        
        # draw_features_heatmap(5,5,out27.cpu().detach(),x.cpu().detach(),"{}/out27.png".format(savepath));print("out28\n")
        # draw_features_heatmap(5,5,out28.cpu().detach(),x.cpu().detach(),"{}/out28.png".format(savepath));print("out29\n")
        # draw_features_heatmap(5,5,out29.cpu().detach(),x.cpu().detach(),"{}/out29.png".format(savepath));print("out30\n")
        # draw_features_heatmap(5,5,out30.cpu().detach(),x.cpu().detach(),"{}/out30.png".format(savepath));print("out31\n")
        # draw_features_heatmap(5,5,out31.cpu().detach(),x.cpu().detach(),"{}/out31.png".format(savepath));print("out32\n")
        # draw_features_heatmap(5,5,out32.cpu().detach(),x.cpu().detach(),"{}/out32.png".format(savepath));print("out33\n")
        # draw_features_heatmap(5,5,out33.cpu().detach(),x.cpu().detach(),"{}/out33.png".format(savepath));print("out34\n")
        # draw_features_heatmap(5,5,out34.cpu().detach(),x.cpu().detach(),"{}/out34.png".format(savepath));print("out35\n")
        # draw_features_heatmap(5,5,out35.cpu().detach(),x.cpu().detach(),"{}/out35.png".format(savepath));print("END\n")
        
        out1_2 = self.m1_2(out35) #out1
        out1_1 = self.m1_1(out35)   #out1
        # draw_features_heatmap(1,8,out1_2.cpu().detach(),"{}/out1_2.png".format(savepath));print("out1_2\n")
        # draw_features_heatmap(1,8,out1_1.cpu().detach(),"{}/out1_1.png".format(savepath));print("out1_1\n")
        if self.stop_at_stage == 1:
            return [out1_2],\
                   [out1_1]

        out2 = torch.cat([out1_2, out1_1, out35], 1) #out1
        out2_2 = self.m2_2(out2)
        out2_1 = self.m2_1(out2)

        # draw_features_heatmap(1,8,out2_2.cpu().detach(),"{}/out2_2.png".format(savepath));print("out2_2\n")
        # draw_features_heatmap(1,8,out2_1.cpu().detach(),"{}/out2_1.png".format(savepath));print("out2_1\n")
        if self.stop_at_stage == 2:
            return [out1_2, out2_2],\
                   [out1_1, out2_1]

        out3 = torch.cat([out2_2, out2_1, out35], 1) #out1
        out3_2 = self.m3_2(out3)
        out3_1 = self.m3_1(out3)

        # draw_features_heatmap(1,8,out3_2.cpu().detach(),"{}/out3_2.png".format(savepath));print("out3_2\n")
        # draw_features_heatmap(1,8,out3_1.cpu().detach(),"{}/out3_1.png".format(savepath));print("out3_1\n")
        if self.stop_at_stage == 3:
            return [out1_2, out2_2, out3_2],\
                   [out1_1, out2_1, out3_1]

        out4 = torch.cat([out3_2, out3_1, out35], 1) #out1
        ...
        out5 = torch.cat([out4_2, out4_1, out35], 1) #out1
        ...
        out6 = torch.cat([out5_2, out5_1, out35], 1) #out1
...
class ModelData(object):
    ...
    def load_net_model_path(self, path):
        ...
        #     dict_new[ str(new_list[i]) ] = dict_trained[ trained_list[i] ]
...
class ObjectDetector(object):
    ...
    def detect_object_in_image(net_model, pnp_solver, in_img, config):
        ...
        # img = ObjectDetector.draw_feature(60,80,feature_maps[0].detach().numpy())
        # plt.imshow()
        # plt.show()
    ...
    def find_object_poses(vertex2, aff, pnp_solver, config):
        ...
        for obj in objects:
            # Run PNP
            points = obj[1] + [(obj[0][0]*16, obj[0][1]*16)]
            ...
            for i_lists in range(len(all_peaks[:-1])):
                ...
                for candidate in lists:
                    ...
                    if objects[i_best][1][i_lists] is None \
                        ...
                        objects[i_best][1][i_lists] = ((candidate[0])*16, (candidate[1])*16)
